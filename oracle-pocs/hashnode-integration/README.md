...
Instead of manually adding links to my hashnode articles, I used the **Hashnode GraphQL API** to fetch my blog posts dynamically and display them inside my Oracle APEX portfolio website.
